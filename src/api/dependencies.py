...
def get_search_engine() -> SearchEngine:
    ...
    if _search_engine is None:
        ...
        # Replace the vector store with our singleton
        _search_engine.vector_store = vector_store
...
def get_query_engine() -> QueryEngine:
    ...
    if _query_engine is None:
        ...
        # Replace the search engine with our singleton
        _query_engine.search_engine = search_engine
